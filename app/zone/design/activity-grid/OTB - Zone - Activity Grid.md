...
1. **Messages - Persistence** - whilst fleshing out the "Manage my Contacts" and "Manage my Groups" Activities I was revisiting other parts of the tree, and I hit a "rough edge" on the "Send a Message" Action. I thought "How do I save a Message?". To cut a long story short, I wondered about whether we should allow a user to save a Message. I thought about it for a while and then did what I nearly always tend to do in this situations, I grabbed my iPhone and tried the closest equivalent action. On the iPhone, it turns out that you can't save a Message, at least not in the "Messages" app, you only get an option to Send or Cancel. This feels right for Zone and so this is what I've documented in the tree above. _Added by Ian._
1. **Meeting Requests - Persistence** - presumably we also won't allow Meeting Requests to be saved - as per Messages - but is this the case? _Added by Ian._
